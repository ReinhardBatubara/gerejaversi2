    ...
    public function up()
{
    Schema::create('layanangereja', function (Blueprint $table) {
        ...
        // Menambahkan kolom 'kode'
        $table->string('kode')->unique()->nullable(); // Unique untuk mencegah duplikasi
        $table->string('nama')->nullable(); // Membuat kolom nama bisa kosong;
        ...
        $table->string('detail_acara')->nullable();
