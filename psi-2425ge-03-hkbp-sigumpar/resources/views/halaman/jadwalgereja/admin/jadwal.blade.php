            ...
            <div class="col-md-6">
                <div class="schedule-box">
                    ...
                    <div class="text-center mt-4">
                        <button type="button" class="btn btn-warning" onclick="toggleForm()">Edit Jadwal</button>
                    </div>

                    <!-- Form Edit Jadwal Massal -->
                                    ...
                                    <div class="row g-2">
                                        <div class="col">
                                            <input type="time" name="jadwal[{{ $index }}][jam_mulai]" class="form-control"
                                                value="{{ $item ? $item->jam_mulai : '' }}" required>
                                        </div>
                                        <div class="col">
                                            <input type="time" name="jadwal[{{ $index }}][jam_selesai]" class="form-control"
                                                value="{{ $item ? $item->jam_selesai : '' }}" required>
                                        </div>
                                        <div class="col">
