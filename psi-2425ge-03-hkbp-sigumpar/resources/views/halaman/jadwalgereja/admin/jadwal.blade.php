<x-app-layout>
    ...
    <x-slot name="scripts">
        ...
        <script>
            ...
            // Fungsi untuk merender tampilan jadwal (read-only)
            ...
            // Fungsi untuk merender form edit jadwal
            ...
            // Membuat satu blok form untuk satu jadwal
            ...
            // Fungsi untuk beralih antara mode view dan mode edit
            function toggleEdit() {
            ...
            // Fungsi untuk menambah jadwal baru di form edit
            function addSchedule() {
                schedulesData.push({ id: null, nama: '', jam_mulai: '', jam_selesai: '', bahasa: '' });
                renderEditSchedules();
            }

            // Fungsi untuk menghapus jadwal (via AJAX)
            function removeSchedule(index) {
                ...
                if (schedule.id) {
                    ...
                    // Jika jadwal baru (belum disimpan), hapus langsung dari array
                    schedulesData.splice(index, 1);
                    renderEditSchedules();
                    renderViewSchedules();
                }
            ...
            // Fungsi untuk mengirim request hapus ke server
            ...
            // Mereset form edit ke nilai terakhir yang disimpan
            function resetEditForm() {
                renderEditSchedules();
            }

            // Menyimpan semua perubahan jadwal ke server
            function saveEdit() {
