<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 fixed top-0 inset-x-0 z-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <x-nav-link :href="route('profilegereja')" :active="request()->routeIs('profilegereja')">
                    {{ __('Profil Gereja') }}
            </x-nav-link>
            </div>
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-nav-link :href="route('warta.index')" :active="request()->routeIs('warta')">
                    {{ __('Warta') }}
                </x-nav-link>
            </div>
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
            ...
            @role('admin') <!-- Only display Data Jemaat for admins -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('halaman.congregations.index')" :active="request()->routeIs('halaman.congregations.index')">
                        {{ __('Data Jemaat') }}
                    </x-nav-link>
                </div>
            @endrole
